    ...
    <div style={{ display: 'flex', height: '100vh', width: '100vw' }}>
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '600px' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', maxWidth: '400px' }}>
            Join the platform building intelligent data insights for high-performing teams.
          </p>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ width: '100%', maxWidth: '380px', padding: '2rem' }}>
          <h2 style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Sign Up</h2>
          <p style={{ color: 'var(--text-muted)', marginBottom: '2.5rem' }}>
            Create an account to manage your organization.
          </p>
