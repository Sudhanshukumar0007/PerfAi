...
export default function EditEmployee() {
  ...
  if (initialLoading) {
    return <div className="skeleton" style={{ height: '400px', width: '100%' }} />;
  }
    ...
    <div style={{ display: 'flex', gap: '4rem', alignItems: 'flex-start' }}>
      <div style={{ flex: 1, maxWidth: '600px' }}>
        <div className="page-header">
          <h1 className="page-title">Edit Personnel</h1>
          <p className="page-subtitle">Update employee details in the organizational directory.</p>
        </div>
